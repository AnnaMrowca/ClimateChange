...
input_path = "C:\\Users\\Ania\\Desktop\\ClimateChange\\GlobalLandTemperaturesByCountry.csv"
df = pd.read_csv(input_path)

letter_u = df['Country'].apply(lambda country: 'u' in country.lower())
countries_with_u = df[letter_u]

contains_93 = df['AverageTemperature'].apply(lambda temperature: '93' in str(temperature))
