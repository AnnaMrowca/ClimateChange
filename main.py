...
modeling_country = ['Poland'] #dt, country = Poland, avegage temperature, Arima, Sarimax, Prophet (sezonowość)
...
model_dataset = modeler.select_country(df=model_dataset,
                                       modeling_country=modeling_country)
